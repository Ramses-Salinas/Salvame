...
<body>
    ...
    <main class="main">
        <!-- /*Portada*/ -->
        <div class="Portada">
            <img class="Portada__imagen" src="imagenes/DelfinRosado.jpg" alt="" />
        </div>

        <section class="main-contenedor">
            <div class="main-contenedor__descripcion">
                <h2>DELFÍN ROSADO</h2>
                <h4>Familia: Iniidae</h4>
                <h4>Especie: Mamífero Cetáceo</h4>
                <p class="Descripcion">
                    Ut sed tincidunt metus. Etiam fringilla et mi vitae iaculis.
                    Phasellus eu sem dictum, posuere odio quis, fringilla libero.
                    Curabitur et risus sem. Donec sit amet purus ornare, pellentesque
                    erat id, consequat risus.
                </p>

                <h4>Departamento: Loreto</h4>

                <h4>Provincia: Iquitos</h4>
            </div>

            <div class="main-contenedor__mapa">
                <img class="main-contenedor__imagen" src="imagenes/LoretoMapa.jpg" alt="" />
            </div>
        </section>
