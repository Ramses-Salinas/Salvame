...
<body>
    ...
    <main class="main">
        <!-- /*Portada*/ -->
        <div class="Portada">
            <img class="Portada__imagen" src="imagenes/Tortuga.jpg" alt="" />
        </div>

        <section class="main-contenedor">
            <div class="main-contenedor__descripcion">
                <h2>TORTUGAS MOTELO</h2>
                <h4>Familia: Testudinidae</h4>
                <h4>Especie: Chelonoidis denticulata</h4>
                <p class="Descripcion">
                    Proin finibus eget risus in placerat. Vestibulum varius dictum arcu,
                    eu viverra ipsum convallis sit amet. Donec pellentesque fermentum
                    lorem sit amet venenatis. Proin velit est, vulputate cursus euismod
                    sed, tincidunt nec arcu. Sed vitae felis orci. Maecenas et mattis
                    metus, ac egestas sapien.
                </p>
